...
%% general metadata:
\newcommand{\myauthor}{Yugant Hadiyal}  %% also used for PDF metadata (hyperref)
\newcommand{\myauthorwithexistingtitles}{\myauthor{}, B.E.}  %% including
                                %% university degree already held
                                %% (BSc, MSc, ...)
\newcommand{\mytitle}{Answering Software
Questions using Neural Networks}  %% also used for PDF metadata (hyperref)
\newcommand{\mysubtitle}{ }  %% only used with title_Thesis_TU_Graz_-_kazemakase
\newcommand{\mysubject}{SUBJECT}  %% also used for PDF metadata (hyperref)
\newcommand{\mykeywords}{KEYWORDS}  %% also used for PDF metadata (hyperref)

%% this information is used only for generating the title page:
\newcommand{\myworktitle}{Literature Review}  %% official type of work like ``Master theses''
\newcommand{\mystudy}{RCSE} %% your study like ``Arts''
\newcommand{\mydegreeprogramme}{Master's degree programme: \mystudy} %% Master's or PhD degree programme
\newcommand{\myuniversity}{Technical University Ilmenau} %% your university/school
\newcommand{\myfaculty}{ }  %% only used with title_Thesis_TU_Graz_-_kazemakase
\newcommand{\myinstitute}{Softwaretechnik für sicherheitskritische Systeme} %% affiliation
\newcommand{\myinstitutehead}{Prof. Dr.-Ing. Patrick Mäder} %% head of institute
\newcommand{\mysupervisor}{MSc. Mihaela Tomova} %% your supervisor
...
\newcommand{\myid}{62154} %% Matrikelnummer
...
\include{introduction}        %% this is a suggestion: you have to create this 
